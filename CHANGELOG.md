...
All notable changes to the HoneyDrunk.Kernel repository are documented in this file.

The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/),
and this project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).

See the per-package changelogs for detailed entries:
...
## 0.8.0 - Maintainability refactor
...
## 0.7.0 - Snapshot and helper consolidation
...
## 0.6.0 - Canonical Node identities
...
## 0.5.0 - First-class tenant identity
